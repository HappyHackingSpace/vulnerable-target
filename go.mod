...
require (
	...
	github.com/docker/cli v29.2.0-rc.2+incompatible
...
replace github.com/tonistiigi/fsutil => github.com/tonistiigi/fsutil v0.0.0-20230825212630-f09800878302

replace github.com/compose-spec/compose-go/v2 => github.com/compose-spec/compose-go/v2 v2.0.0-rc.7

replace github.com/fsnotify/fsevents => github.com/fsnotify/fsevents v0.1.1
